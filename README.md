...
**Model File:** [Download best_multi_class_model.h5](https://huggingface.co/spaces/narmeenbilal/Neuro-AI-Detector)  
> 
...
```bash
git clone https://github.com/Saharejazkhan/neuro-ai-cancer-detector.git
